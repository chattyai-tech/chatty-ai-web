...
const officeApps = [
  {
    ...
    description:
      'AI-powered writing assistant that helps you draft, edit, and enhance documents with enterprise knowledge.',
    features: [
      {
        icon: PenTool,
    ...
    demo: {
      ...
      content:
        'The Q3 2024 results show significant growth across all segments...',
      aiSuggestion:
        'Add specific revenue figures from the financial database for clarity',
    },
  },
  {
    id: 'excel',
    ...
    description:
      'Transform data analysis with natural language queries. Ask questions about your spreadsheets and get instant insights.',
    features: [
      {
        icon: MessageSquare,
  ...
  },
  {
    ...
    description:
      'Create stunning presentations faster with AI-generated content, layouts, and speaker notes from your knowledge base.',
    features: [
      {
        icon: Sparkles,
  ...
  },
  {
    ...
    description:
      'Supercharge your email productivity with AI-powered drafting, summarization, and intelligent responses.',
    features: [
      {
        icon: PenTool,
    ...
    demo: {
      ...
      aiDraft:
        'Thank you for the update. Based on the current progress, I suggest we...',
    },
  },
];
...
const howItWorksSteps = [
  {
    ...
    description:
      'Download ChattyAI from the Microsoft AppSource marketplace and install it across your organization with one click.',
    icon: Download,
  },
  {
    step: 2,
    ...
    description:
      'Securely connect your enterprise knowledge base, documents, databases, and internal systems to ChattyAI.',
    icon: Settings,
  },
  {
    step: 3,
    ...
    description:
      'Access ChattyAI directly within Word, Excel, PowerPoint, and Outlook. Your AI assistant is always just a click away.',
    icon: Play,
  },
];
...
export default function ChattyForWordPage() {
  ...
  const currentApp =
    officeApps.find((app) => app.id === activeApp) || officeApps[0];
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div className="space-y-8">
              ...
              <p className="text-lg lg:text-xl text-[var(--text-secondary)] leading-relaxed max-w-xl">
                Bring enterprise AI directly into Word, Excel, PowerPoint, and
                Outlook. Access your company knowledge, automate tasks, and work
                smarter — all without leaving Microsoft 365.
              </p>
        ...
        <ScrollReveal key={app.id}>
          ...
          >
            <div className="absolute inset-0 pointer-events-none">
              <div
                className={`absolute ${
                  idx % 2 === 0 ? '-right-40 top-20' : '-left-40 bottom-20'
                } w-[500px] h-[500px] bg-gradient-to-br from-purple-500/10 to-violet-500/10 rounded-full blur-[120px] opacity-50`}
              />
            </div>
              ...
              >
                ...
                >
                  ...
                  <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-purple-500/10 border border-purple-500/20 text-sm font-semibold mb-6">
                    ...
                    <span className="text-purple-400">{app.name}</span>
                  </div>
        ...
        >
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
            <div className="text-center mb-20">
              ...
              >
                Get up and running in minutes with our seamless Microsoft 365
                integration.
              </motion.p>
            </div>
...
function AppDemo({ app }: { app: (typeof officeApps)[0] }) {
        ...
        <div className="bg-white dark:bg-gray-900 rounded-lg p-4 border border-gray-200 dark:border-gray-700">
          ...
          <div className="flex items-center gap-2 p-3 rounded-lg bg-purple-500/10 border border-purple-500/20">
            ...
            <span className="text-sm text-purple-400">
              {app.demo.aiSuggestion}
            </span>
          </div>
        </div>
        <div className="flex gap-2">
          <button className="px-3 py-1.5 rounded-lg bg-gradient-to-r from-purple-500 to-violet-600 text-white text-xs font-medium">
            Accept
          </button>
          <button className="px-3 py-1.5 rounded-lg bg-[var(--bg-surface)] border border-[var(--border-primary)] text-xs font-medium text-[var(--text-secondary)]">
            Modify
          </button>
        </div>
      </div>
  ...
  if (app.id === 'powerpoint') {
    return (
      <div className="space-y-4">
        <div className="text-sm font-medium text-[var(--text-primary)] mb-2">
          Generated Presentation: {app.demo.title}
        </div>
