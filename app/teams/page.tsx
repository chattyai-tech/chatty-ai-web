    ...
    members: [
      {
        ...
        linkedin: 'https://www.linkedin.com/in/amiram-amsalem-510953142/',
      },
      {
        name: 'Doron Basson',
        role: 'VP Business Development',
        image: '/image.png',
        linkedin: 'https://www.linkedin.com/in/doron-bason-38917231/',
      },
      {
        name: 'Amit Avraham',
        role: 'Chief Operating Officer',
        image: '/ChatGPT Image Dec 22, 2025, 12_36_58 PM.png',
        linkedin: 'https://www.linkedin.com/in/amit-avraham-6899b531/',
      },
    ],
  },
  {
    ...
    members: [
      {
        ...
        linkedin: 'https://www.linkedin.com/in/neriyacohen/',
      },
      {
        name: 'Eilon Steinberg',
        role: 'Project Manager',
        image: '/ChatGPT Image Dec 22, 2025, 12_36_56 PM.png',
        linkedin: '#',
      },
      {
        name: 'Shani Passov',
        ...
        linkedin: 'https://www.linkedin.com/in/shani-passov-9038aa254/',
      },
    ],
  },
  {
    ...
    members: [
      {
        name: 'Alexander Kozar',
        role: 'Head of R&D',
        image: '/1559048617712 (1).jpg',
        linkedin: 'https://www.linkedin.com/in/olexandr-kozar-69a256185/',
      },
      {
        name: 'Ivan Sazanov',
        role: 'Senior Software Developer',
        image: '/1757314202937.jpg',
        linkedin: 'https://www.linkedin.com/in/iwance/',
      },
    ],
  },
];
  ...
  return (
    ...
    >
      ...
      <div className="relative mb-5">
        <div
          className={`relative w-40 h-40 sm:w-44 sm:h-44 rounded-full overflow-hidden transition-all duration-300 ${
            isHovered
              ? `ring-4 ${colors.ring}/50 shadow-xl`
              : 'ring-2 ring-[var(--border-primary)]'
          }`}
        >
          {member.image && !imageError ? (
            ...
            <div
              className={`absolute inset-0 bg-gradient-to-br ${colors.bg} flex items-center justify-center`}
            >
        ...
        <div className="relative z-10 max-w-3xl mx-auto px-4 text-center">
          <div>
            ...
            <p className="text-lg text-[var(--text-secondary)] max-w-2xl mx-auto leading-relaxed">
              A diverse team of experts united by a mission to make enterprise
              AI accessible and secure.
            </p>
          </div>
        </div>
      </section>
